...
if($_SERVER['REQUEST_METHOD'] == 'POST'){ // se o método usado for POST execute o if
    ...
    if(move_uploaded_file($_FILES['imagem'] // a função move o arquivo que foi carregado, essa função ta pegando o campo de imagem do form
    ['tmp_name'], $target_file)){ // vai pegar a imagem e jogar em um arquivo temporário (tmp_name)  direciona para o $target_file
